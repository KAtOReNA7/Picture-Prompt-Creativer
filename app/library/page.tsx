...
export default async function LibraryPage({ searchParams }: LibraryPageProps) {
  ...
  const currentTag = params.tagId ? await prisma.tag.findUnique({ where: { id: params.tagId }, select: { name: true, category: true } }) : null;
  ...
  return (
    <AppShell>
      ...
      <form className="mb-6 grid gap-3 rounded-md border border-slate-200 bg-white p-4 shadow-sm lg:grid-cols-[1.4fr_0.8fr_0.8fr_0.8fr_0.8fr_0.8fr_auto]">
        <input
          name="q"
